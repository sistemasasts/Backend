...
import com.isacore.servicio.reporte.ReporteConstantes;
...
public class GenerateReportQuality {
    ...
    public static String runReportJasperHcc(ReportDto rep, String reporteRutaBase) {
        ...
        try {
            parameters.put(ReporteConstantes.LOGO_PARAMETRO, GenerateReportQuality.getImagenStream(ReporteConstantes.LOGO_IMAGEN));
            parameters.put(ReporteConstantes.FONDO_PARAMETRO, GenerateReportQuality.getImagenStream(ReporteConstantes.FONDO_IMAGEN));
            parameters.put(ReporteConstantes.SELLO_CALIDAD_PARAMETRO, GenerateReportQuality.getImagenStream(ReporteConstantes.SELLO_CALIDAD_IMAGEN));
    ...
    public static String runReportJasperQualityCertificate(ReportDto qc, String reporteRutaBase) {
        ...
        try {
            parameters.put(ReporteConstantes.LOGO_PARAMETRO, GenerateReportQuality.getImagenStream(ReporteConstantes.LOGO_IMAGEN));
            parameters.put(ReporteConstantes.FONDO_PARAMETRO, GenerateReportQuality.getImagenStream(ReporteConstantes.FONDO_IMAGEN));
            parameters.put(ReporteConstantes.FIRMA_SANDRA_PARAMETRO, GenerateReportQuality.getImagenStream(ReporteConstantes.FIRMA_SANDRA_IMAGEN));
            parameters.put(ReporteConstantes.SELLO_CALIDAD_PARAMETRO, GenerateReportQuality.getImagenStream(ReporteConstantes.SELLO_CALIDAD_IMAGEN));
    ...
    public static InputStream getImagenStream(String imageName) {
        String imagenBase = "/images/";
        InputStream is = GenerateReportQuality.class.getResourceAsStream(imagenBase + imageName);
        if (is == null) {
