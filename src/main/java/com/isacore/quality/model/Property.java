...
*/
	...
	public Property(Product product, PropertyList propertyList,String unit, Double minValue, Double maxValue, String norm, String typeProperty, String viewProperty, String asUser) {
		this.product = product;
